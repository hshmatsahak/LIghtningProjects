...
class Board:
    ...
    def assign_values_to_board(self):
        # now that we have the bombs planted, let's assign a number 0-8 for all the empty spaces that
        # represents how many neighbouring bombs there are. We can precompute these and it'll save 
    ...
    def dig(self, row, col):
        ...
        # dug at location with no neighbouring bombs -> recursively dig neighbours!
